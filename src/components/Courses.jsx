...
const Courses = () => {
    ...
    useEffect(() => {
        settotalItems(x.length)
    }, [totalItems])


    return (
        <div className="flex flex-col xl:flex-row w-full px-8 ">
            <div className={`w-full   rounded-lg flex flex-col lg:px-6 py-4 gap-6  ${!loading ? "lg:h-[430px]" : "lg:h-auto"}`}>
                ...
                <div className="header flex justify-between items-center">
                    ...
                    <div className="SearchInput hidden lg:flex    h-10 w-80 bg-text_FF rounded-full  justify-start p-5 items-center text-textColor__2 text-lg"  >
                        <input
                            ...
                            className={"bg-inherit w-full  text-sm text-mainColor font-bold placeholder:font-semibold   border-none rounded-sm "} type="search" />
                ...
                <div className="largeScreen hidden lg:table   h-full ">
                    {!loading ? <>
                        ...
                        {visibleData2?.map((item, i) => {
                            return (
                                <Link to={`/course/${i}`} key={i} className="content bg-white relative">
                                    <div onClick={e => {
                                        e.stopPropagation()
                            ...
                            return (
                                ...
                                <Disclosure key={i} >
                                    {({ open }) => (
                                        <div>
                                            <Disclosure.Button
                                                className={`py-4 px-6 w-full bg-text_FF shadow-sm border-[#E1E1E1] border-b flex items-center justify-between rounded-2xl ${open ? "rounded-b-none" : "rounded-b-2xl"
                                                    }`}
                                            >
                                                ...
                                                <div className="flex gap-x-2 items-center ">
                                                    {!open ? <i className="fa-solid fa-chevron-right"></i>
